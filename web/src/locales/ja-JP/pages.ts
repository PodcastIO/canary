export default {
  'pages.podcasts.addPodcastBtn.title': '新しいポッドキャスト',
  'pages.podcasts.loadingMore': 'もっと読み込む',
  'pages.podcasts.edit': '編集',
  'pages.podcasts.remove': '消去',

  'pages.podcastForm.addTitle': 'ポッドキャストを追加しました',
  'pages.podcastForm.editTitle': 'ポッドキャストを編集します',
  'pages.podcastForm.source': 'ソース',
  'pages.podcastForm.localSource': 'ローカル',
  'pages.podcastForm.rssSource': 'RSS',
  'pages.podcastForm.videoSource': 'ビデオ',
  'pages.podcastForm.localFile': 'ローカルファイル',
  'pages.podcastForm.localFile.placeholder': 'ファイルをアップロードしてください',
  'pages.podcastForm.rssUrl': 'RSSアドレス',
  'pages.podcastForm.rssUrl.placeholder': 'RSSアドレスを入力してください',
  'pages.podcastForm.videoUrl.placeholder': 'ビデオアドレスを入力してください',
  'pages.podcastForm.videoUrl': 'ビデオアドレス ',
  'pages.podcastForm.language': '言語',
  'pages.podcastForm.language.placeholder': '言語を選択してください',
  'pages.podcastForm.language.chinese': '中国語',
  'pages.podcastForm.language.english': '英語',
  'pages.podcastForm.language.japanese': '日本',
  'pages.podcastForm.language.german': 'ドイツ人',
  'pages.podcastForm.language.french': 'フランス語',
  'pages.podcastForm.language.netherland': 'オランダの',
  'pages.podcastForm.language.spanish': 'スペイン語',
  'pages.podcastForm.title': '題名',
  'pages.podcastForm.title.placeholder': 'タイトル名を入力してください',
  'pages.podcastForm.author': '著者',
  'pages.podcastForm.author.placeholder': '著者の名前を入力してください ',
  'pages.podcastForm.cover': 'カバー',
  'pages.podcastForm.description': '説明',
  'pages.podcastForm.description.placeholder': '説明を入力してください',
  'pages.podcastForm.pullFirstTime': '初めて',
  'pages.podcastForm.frequency': '間隔',
  'pages.podcastForm.frequency.hour': '時間',
  'pages.podcastForm.frequency.day': '空',
  'pages.podcastForm.frequency.week': '週',
  'pages.podcastForm.frequency.month': '月',
  'pages.podcastForm.frequency.year': '年',
  'pages.podcastForm.submit': '参加する',
  'pages.podcastForm.cancel': 'キャンセル',
  'pages.uploadFile.description': 'このエリアのファイルをクリックまたはドラッグします',
  'pages.login.title': '黄金の鳥',
  'pages.login.subTitle': 'ドキュメント、RSS、ビデオをポッドキャストに変換するためのツール',
  'pages.login.email.placeholder': '郵便',
  'pages.login.email.required': 'メールボックスは必須アイテムです',
  'pages.login.success': 'ログイン成功',
  'pages.sendConfirmLogin.title': '確認ログインメールの成功を送信します ',
  'pages.sendConfirmLogin.subTitle':
    '<a>メールボックス</a>にログインし、ログイン確認メールを見つけ、ログイン確認リンクをクリックして、システムにログインします。',
  'pages.confirmLogin.title': 'ログインが失敗したことを確認してください ',
  'pages.confirmLogin.backLogin': 'ログインページに戻ります',
  'pages.confirmLogin.subTitle': 'あなたが無効である場合は、re -login </a>をご覧ください</a>。 ',
  'pages.login.failure': 'ログインに失敗しました、もう一度やり直してください!',
  'pages.podcastForm.shareEnable': 'シェア',
  'pages.podcastForm.shareTime': '時間を共有します',

  'pages.podcastForm.share_time.hour': '時間',
  'pages.podcastForm.share_time.day': '空',
  'pages.podcastForm.share_time.week': '週',
  'pages.podcastForm.share_time.month': '月',
  'pages.podcastForm.share_time.year': '年',
  'pages.podcastForm.share_time.forever': '永久',
